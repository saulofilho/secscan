...
export const COMPLIANCE_CONTROLS_CATALOG: ComplianceControlDefinition[] = [
  ...
  },
  {
    ...
    frameworkName: 'SOC 2 Type II',
    code: 'CC8.1',
    title: 'Change Management & Segregation of Environments',
    category: 'Gestão de Mudanças & Segregação',
    description: 'A organização autoriza, projeta, desenvolve, testa e implementa mudanças em sistemas para prevenir credenciais de produção em ambientes de homologação e código-fonte.',
    auditImplication: 'Apontamento de falha de Change Management. Segredos de produção commitados em repositórios acessíveis a equipes sem autorização formal.',
    recommendedRemediation: 'Separar vaults de segredos entre ambientes (dev, staging, prod) e implementar checagens automáticas pré-commit.',
    severityThreshold: 'HIGH',
    matchingCategories: ['PASSWORD', 'DATABASE_URI', 'CLOUD_CREDENTIAL'],
    matchingKeywords: ['env', 'production', 'staging', 'database', 'secret', 'password'],
    docUrl: 'https://www.aicpa.org/trustservices',
  },
  ...
  },
  {
    ...
    frameworkName: 'HIPAA Security Rule',
    code: '§ 164.312(b)',
    title: 'Audit Controls & Security Event Logging',
    category: 'Controles de Auditoria & Trilha',
    description: 'Mecanismos de hardware, software ou procedimentos para registrar e examinar atividades em sistemas que contêm ou usam ePHI.',
    auditImplication: 'Auditorias do OCR penalizam a incapacidade de rastrear quem acessou registros médicos devido a chaves genéricas compartilhadas.',
    recommendedRemediation: 'Eliminar credenciais mestre compartilhadas em arquivos de configuração e adotar identificadores únicos por serviço auditável.',
    severityThreshold: 'HIGH',
    matchingCategories: ['API_KEY', 'AUTH_TOKEN', 'CLOUD_CREDENTIAL'],
    matchingKeywords: ['audit', 'log', 'key', 'token', 'access', 'trace'],
    docUrl: 'https://www.hhs.gov/hipaa/for-professionals/security/laws-regulations/index.html',
  },
  {
    id: 'hipaa-164-312-d',
    ...
    frameworkName: 'HIPAA Security Rule',
    code: '§ 164.312(d)',
    title: 'Person or Entity Authentication Verification',
    category: 'Autenticação de Entidades & Pessoas',
    description: 'Procedimentos para verificar se uma pessoa ou entidade que busca acesso a dados de saúde (ePHI) é de fato quem alega ser.',
    auditImplication: 'Uso de chaves de API estáticas e senhas simples viola a obrigatoriedade de autenticação forte e não repúdio.',
    recommendedRemediation: 'Substituir senhas fixas e segredos por tokens transitórios baseados em certificados mTLS e OAuth2 federado.',
    severityThreshold: 'CRITICAL',
    matchingCategories: ['PASSWORD', 'API_KEY', 'PRIVATE_KEY'],
    matchingKeywords: ['password', 'auth', 'cert', 'identity', 'login'],
    docUrl: 'https://www.hhs.gov/hipaa/for-professionals/security/laws-regulations/index.html',
  },
  ...
  },
  {
    ...
    frameworkName: 'ISO/IEC 27001:2022',
    code: 'A.5.15',
    title: 'Access Control & Privileged Identity Rights',
    category: 'Controle de Acesso & Identidade',
    description: 'Regras de controle de acesso lógico baseadas em necessidades operacionais e de segurança, proibindo credenciais genéricas ou administrativas hardcoded.',
    auditImplication: 'Não conformidade maior na cláusula A.5.15 em auditorias de certificação ISO/IEC 27001.',
    recommendedRemediation: 'Implementar controle de acesso baseado em papéis (RBAC) e revogar credenciais embutidas no código-fonte.',
    severityThreshold: 'HIGH',
    matchingCategories: ['AUTH_TOKEN', 'PASSWORD', 'API_KEY'],
    matchingKeywords: ['access', 'privilege', 'admin', 'identity', 'role', 'auth'],
    docUrl: 'https://www.iso.org/standard/27001',
  },
  {
    id: 'iso-a-8-12',
    ...
    frameworkName: 'ISO/IEC 27001:2022',
    code: 'A.8.12',
    title: 'Data Leakage Prevention in Source Repositories',
    category: 'Prevenção de Vazamento de Dados (DLP)',
    description: 'Medidas aplicadas para detectar e prevenir a divulgação não autorizada de dados confidenciais, chaves e credenciais em repositórios de código.',
    auditImplication: 'Apontamento crítico de falha nas salvaguardas de DLP contra exfiltração acidental de segredos para a nuvem pública.',
    recommendedRemediation: 'Ativar varreduras pré-commit, filtros em githooks e verificação de entropia contínua.',
    severityThreshold: 'CRITICAL',
    matchingCategories: ['CLOUD_CREDENTIAL', 'PRIVATE_KEY', 'ENTROPY', 'CUSTOM_REGEX'],
    matchingKeywords: ['dlp', 'leak', 'secret', 'sprawl', 'git', 'entropy'],
    docUrl: 'https://www.iso.org/standard/27001',
  },
];
